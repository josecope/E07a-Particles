...
class Particle(arcade.Sprite):
    def __init__(self, asset, scale, x, y, dx, dy, ax, ay, decay):
        ...
        self.particle_colors = [
            ...
            ,(open_color.yellow_9, 7)
            ,(open_color.yellow_8, 8)
            ,(open_color.red_1, 8)
            ,(open_color.orange_3, 8)
            ,(open_color.gray_7, 7)
            ,(open_color.gray_8, 9)
            ,(open_color.gray_9, 5)
            ,(open_color.gray_5, 4)
...
class Window(arcade.Window):
    ...
    def __init__(self, width, height, title):
        ...
        arcade.set_background_color(open_color.pink_0)
    ...
    def update(self, delta_time):
        ...
        if self.mouse_down:
            ...
            particle = Particle('star_09',scale,x,y,dx,dy,ax,ay,decay)
